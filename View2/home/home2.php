<?php include "../temp/home2header1.inc"; ?>
<?php include "../temp/home2header2.inc"; ?>
                    ...
                    <div class="span12 bg-gray">
                        <div class="tabbable">
                            <ul class="red-bar nav nav-tabs" id="myTabs">
                                <li class="active"><a href="#home" data-toggle="tab">贴友墙动态 <span class="badge">6</span></a></li>
                            ...
                            <div class="news-box tab-content">
                                <div class="tab-pane active" id="home">
                                    <div class="row-fluid photo-info">
                                        ...
                                        <div class="span7">
                                            <h5>ANGLED1</h5>
                                            <p>于2012年12月10日11:36上传<font class="text-error">3</font>张新照片！</p>
                                            <p>通过网页版客户端</p>
                        ...
                        <div class="span12">
                        	...
                        	<div class="row-fluid rec-friend">
                                ...
                                <div class="span5">
                                    ...
                                    <p class="no-space">有<font class="text-error">{#$recommendation_friends[$k].common_friends_num#}</font>个共同贴友</p>
                        	...
                        	<div class="row-fluid rec-friend">
                                ...
                                <div class="span5">
                                	<h5>刘嘉阳</h5>
                                    <p class="no-space">有<font class="text-error">8</font>个共同贴友</p>
                        	...
                        	<div class="row-fluid rec-friend">
                                ...
                                <div class="span5">
                                	<h5>孙小圣</h5>
                                    <p class="no-space">有<font class="text-error">6</font>个共同贴友</p>
                        			<i class="icon-map-marker"></i><a class="location" href="#">青岛，中国</a>
                                </div>
                                <div class="span2">
                                	<a href="#"><p class="no-space">忽略</p></a>
                        	...
                        	<div class="row-fluid rec-friend">
                                ...
                                <div class="span5">
                                	<h5>张小懒</h5>
                                    <p class="no-space">有<font class="text-error">4</font>个共同贴友</p>
                        			<i class="icon-map-marker"></i><a class="location" href="#">青岛，中国</a>
                                </div>
                                <div class="span2">
                                	<a href="#"><p class="no-space">忽略</p></a>
                        	...
                        	<div class="row-fluid rec-friend">
                                ...
                                <div class="span5">
                                	<h5>韩</h5>
                                    <p class="no-space">有<font class="text-error">2</font>个共同贴友</p>
                        			<i class="icon-map-marker"></i><a class="location" href="#">青岛，中国</a>
                                </div>
                                <div class="span2">
                                	<a href="#"><p class="no-space">忽略</p></a>
                        	...
                        	<div class="row-fluid rec-friend">
                                ...
                                <div class="span5">
                                	<h5>SISI</h5>
                                    <p class="no-space">有<font class="text-error">1</font>个共同贴友</p>
                        			<i class="icon-map-marker"></i><a class="location" href="#">青岛，中国</a>
                                </div>
                                <div class="span2">
                                	<a href="#"><p class="no-space">忽略</p></a>
                    ...
                    <div class="span12 bg-gray">
                        ...
                        <div class="span12">
                        	<div class="row-fluid rec-friend">
                                ...
                                <div class="span5">
                                	<h5>刘嘉阳</h5>
                                    <p class="no-space">有<font class="text-error">8</font>个共同兴趣标签</p>
                        			<i class="icon-map-marker"></i><a class="location" href="#">青岛，中国</a>
                                </div>
                                <div class="span2">
                                	<a href="#"><p class="no-space">忽略</p></a>
                        	...
                        	<div class="row-fluid rec-friend">
                                ...
                                <div class="span5">
                                	<h5>孙小圣</h5>
                                    <p class="no-space">有<font class="text-error">6</font>个共同兴趣标签</p>
                        			<i class="icon-map-marker"></i><a class="location" href="#">青岛，中国</a>
                                </div>
                                <div class="span2">
                                	<a href="#"><p class="no-space">忽略</p></a>
                        	...
                        	<div class="row-fluid rec-friend">
                                ...
                                <div class="span5">
                                	<h5>张小懒</h5>
                                    <p class="no-space">有<font class="text-error">4</font>个共同兴趣标签</p>
                        			<i class="icon-map-marker"></i><a class="location" href="#">青岛，中国</a>
                                </div>
                                <div class="span2">
                                	<a href="#"><p class="no-space">忽略</p></a>
                        	...
                        	<div class="row-fluid rec-friend">
                                ...
                                <div class="span5">
                                	<h5>韩</h5>
                                    <p class="no-space">有<font class="text-error">2</font>个共同兴趣标签</p>
                        			<i class="icon-map-marker"></i><a class="location" href="#">青岛，中国</a>
                                </div>
                                <div class="span2">
                                	<a href="#"><p class="no-space">忽略</p></a>
                        	...
                        	<div class="row-fluid rec-friend">
                                ...
                                <div class="span5">
                                	<h5>SISI</h5>
                                    <p class="no-space">有<font class="text-error">1</font>个共同兴趣标签</p>
                        			<i class="icon-map-marker"></i><a class="location" href="#">青岛，中国</a>
                                </div>
                                <div class="span2">
                                	<a href="#"><p class="no-space">忽略</p></a>
...
<?php include '../temp/home2footer.inc'?>